...
import { AbstractQueuedGateway } from './QueuedGateway';
import { IQueuedGatewayDefinition } from './QueuedGatewayDefinition';
...
describe('Gateway', () => {
  ...
  class TestGateway extends AbstractQueuedGateway {
